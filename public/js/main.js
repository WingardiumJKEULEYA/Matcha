...
// Validateur si zero tags selectionnés au submit #ACCOUNT
...
$(document).ready(function(){
  ...
  $('#visits_list').hide(); // Liste des visites sur account cachee par defaut
  ...
  $('#suggestion_refresh').click(function() {
    ...
    // Validateur si zero tags selectionnés au submit #SUGGESTION
  ...
  $('#search_refresh').click(function() {
    ...
    // Validateur si zero tags selectionnés au submit #SEARCH
